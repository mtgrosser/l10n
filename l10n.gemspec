...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'activerecord', '>= 7.0.0', '~> 7.2'
  s.add_dependency 'activesupport', '>= 7.0.0', '~> 7.2'
  s.add_dependency 'actionpack', '>= 7.0.0', '~> 7.2'
  s.add_dependency 'railties', '>= 7.0.0', '~> 7.2'
end
