...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency 'activerecord', '>= 6.0.0.rc1', '< 7'
  s.add_runtime_dependency 'activesupport', '>= 6.0.0.rc1', '< 7'
  s.add_runtime_dependency 'actionpack', '>= 6.0.0.rc1', '< 7'
  s.add_runtime_dependency 'railties', '>= 6.0.0.rc1', '< 7'
